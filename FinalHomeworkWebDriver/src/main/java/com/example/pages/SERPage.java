...
public class SERPage {
    ...
    public List<Float> getSnippetPrices(){
        ...
        for (WebElement resultPrice: snippetPrices) {
            ...
            if (itemPriceTextField.contains("до"))
                itemPriceTextField = itemPriceTextField.substring(0,itemPriceTextField.indexOf("до")-1);
            if (itemPriceTextField.contains("to"))
                itemPriceTextField = itemPriceTextField.substring(0,itemPriceTextField.indexOf("to")-1);
            if (itemPriceTextField.contains("Ценовой"))
                itemPriceTextField = itemPriceTextField.substring(0,itemPriceTextField.indexOf("Ценовой")-1);
            if (itemPriceTextField.contains("Trend"))
                itemPriceTextField = itemPriceTextField.substring(0,itemPriceTextField.indexOf("Trend")-1);
